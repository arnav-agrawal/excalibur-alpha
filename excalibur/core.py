...
from excalibur.misc import write_output
...
def compute_cross_section(input_dir, database, molecule, log_pressure, temperature, isotope = 'default', 
    ...
    linelist, isotopologue = parse_directory(input_directory, database)
    ...
    for p in range(N_P):
        for t in range(N_T):
            ...
            nu, sigma = write_output(output_directory, molecule, T, np.log10(P), nu_out, sigma_out)
